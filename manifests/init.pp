...
class jupyterhub (
  ...
  Optional[String] $pip_version::batchspawner,
  Optional[String] $pip_version::jupyter,
  Optional[String] $pip_version::jupyterhub,
  Optional[String] $pip_version::sudospawner,
  Optional[String] $pip_version::systemdspawner,
  Optional[String] $pip_version::wrapspawner,
  Optional[String] $pip_version::wrapspawner,
  Optional[String] $pip_version::wrapspawner,
